...
- **Receita da plataforma (2026-08-19):** o WhatTheChip retém uma **taxa de serviço** (`Company.service_fee_pct`, padrão **10%**) sobre o resultado de cada venda. O comprador paga o WTC o total CHEIO; o WTC repassa ao cliente o LÍQUIDO (`Invoice.net_usd`), registrando o `Payout`. **Duas pernas separadas**, e o cliente NUNCA vê a do comprador (valor, data, referência ou comprovante) — é segredo de mercado. A taxa congela na fatura na emissão, como o câmbio. Detalhe em `PRECIFICACAO.md §12.19`.
