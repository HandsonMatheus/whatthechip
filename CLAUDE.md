...
python manage.py load_brands --brand piecemakers   # PieceMakers — MIGRADA p/ YAML (passo 4): lê chips/knowledge/piecemakers.yaml, valida c/ Pydantic, sobe catalog_version. (populate_piecemakers APOSENTADO.) Dry-run padrão; --commit grava.
