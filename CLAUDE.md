...
python manage.py load_brands --brand piecemakers   # Marcas MIGRADAS p/ YAML (passo 4): piecemakers, gigadevice. Lê chips/knowledge/<marca>.yaml, valida c/ Pydantic, sobe catalog_version. (populate_piecemakers/populate_gigadevice APOSENTADOS.) Dry-run padrão; --commit grava.
