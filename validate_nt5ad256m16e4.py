...
YAML_PATH = "submissions/nanya_nt5ad_256m16e4_2026-08-26.yaml"
PNS = ["NT5AD256M16E4-JR", "NT5AD256M16E4-JRI", "NT5AD256M16E4-HR", "NT5AD256M16E4-HRT"]
CASE_PN = "NT5AD256M16E4"  # PN exato do debug ao vivo (sem sufixo)
...
try:
    ...
    print(f"\n=== 2) classify({CASE_PN}) ANTES -- reproduz o debug ===")
    r = classify(CASE_PN)
