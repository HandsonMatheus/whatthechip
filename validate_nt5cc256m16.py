...
YAML_PATH = "submissions/nanya_nt5cc_256m16_2026-08-20.yaml"
PNS = ["NT5CC256M16ER-EK", "NT5CC256M16ER-DI", "NT5CC256M16EP-DI", "NT5CC256M16EQ-DIA"]
CASE_PN = "NT5CC256M16EREK"  # PN exato do debug ao vivo (sem separador)
...
try:
    ...
    print(f"\n=== 7) classify({CASE_PN}) DE NOVO -- PN exato da bancada ===")
    r = classify(CASE_PN)
