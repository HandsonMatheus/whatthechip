...
urlpatterns = [
    ...
    path('<int:pk>/despacho/', views.so_ship, name='so_ship'),
    # Repasse ao cliente (WTC → cliente, líquido da taxa): só plataforma.
    path('<int:pk>/repasse/', views.so_payout, name='so_payout'),
