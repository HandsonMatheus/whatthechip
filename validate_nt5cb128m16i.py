...
YAML_PATH = "submissions/nanya_nt5cb_128m16i_2026-08-20.yaml"
PNS = ["NT5CB128M16IP-EK", "NT5CB128M16IP-DI", "NT5CB128M16IN-DIA", "NT5CB128M16IN-EKA"]
CASE_PN = "NT5CB128M16IPEK"  # PN exato do debug ao vivo (sem hifen)
...
try:
    ...
    print(f"\n=== 7) classify({CASE_PN}) DE NOVO -- PN exato da bancada, sem hifen ===")
    r = classify(CASE_PN)
