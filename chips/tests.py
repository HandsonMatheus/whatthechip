...
_SAM_GOLDEN = {
    ...
    'KM3H6001CA': ('eMCP', '', 'eMMC 5.1 64GB', 'LPDDR4X 6GB', '', 'RENTÁVEL'),
    'KM3P6001CM': ('eMCP', '', 'eMMC 5.1 64GB', 'LPDDR4X 6GB', '', 'RENTÁVEL'),
    ...
    'KM5P9001DM': ('uMCP', '', 'UFS ⚠ cap. não mapeada', 'LPDDR4X ⚠ cap. não mapeada', '', 'INDETERMINADO'),
